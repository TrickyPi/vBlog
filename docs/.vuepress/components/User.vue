<template>
    <div class="visitor" @click="login">
        ...
        <span
            :style="
                !visitor.name ? { cursor: 'pointer', marginLeft: '4px' } : ''
            "
            >{{ visitor.name || "请登入" }}</span
        >
    </div>
</template>
<script>
